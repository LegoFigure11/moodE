...
const HOMOGLYPHS = {
	...
	"b": ["\u{0062}", "\u{10ee}", "\u{0253}", "\u{15af}", "\u{1d5bb}", "\u{ddbb}", "\u{07d5}", "\u{1d623}", "\u{de23}", "\u{042c}", "\u{1472}", "\u{0185}", "\u{1d41b}", "\u{dc1b}", "\u{1d5ef}", "\u{ddef}", "\u{0180}", "\u{1d47}", "\u{0184}", "\u{0183}", "\u{042a}", "\u{048c}", "\u{2422}", "\u{1483}", "\u{13cf}", "\u{1d6c}", "\u{1d657}", "\u{de57}", "\u{044c}", "\u{1d68b}", "\u{de8b}", "\u{10a6}", "\u{03e6}", "\u{2c13}", "\u{1d587}", "\u{dd87}", "\u{1d483}", "\u{dc83}", "\u{1d44f}", "\u{dc4f}", "\u{048d}", "\u{044a}", "\u{266d}"],
	"c": ["\u{0043}", "\u{03f9}", "\u{1d5a2}", "\u{dda2}", "\u{216d}", "\u{1d5d6}", "\u{ddd6}", "\u{0421}", "\u{0063}", "\u{03f2}", "\u{2201}", "\u{0441}", "\u{1d5bc}", "\u{ddbc}", "\u{1d63e}", "\u{de3e}", "\u{217d}", "\u{1455}", "\u{1d04}", "\u{1d60a}", "\u{de0a}", "\u{1d9c}", "\u{1d624}", "\u{de24}", "\u{13df}", "\u{2ca4}", "\u{1466}", "\u{14bc}", "\u{104a8}", "\u{dca8}", "\u{1d41c}", "\u{dc1c}", "\u{1d5f0}", "\u{ddf0}", "\u{2ca5}", "\u{1d672}", "\u{de72}", "\u{1d658}", "\u{de58}", "\u{13e3}", "\u{0297}", "\u{1d68c}", "\u{de8c}", "\u{2d4e}", "\u{1d484}", "\u{dc84}", "\u{0368}", "\u{1d450}", "\u{dc50}", "\u{00e7}", "\u{1d4d2}", "\u{dcd2}", "\u{1974}", "\u{1d4ec}", "\u{00A2}", "\u{1D554}"],
	"d": ["\u{1d659}", "\u{ff44}", "\u{1d41d}", "\u{13e7}", "\u{a4d2}", "\u{1d4ed}", "\u{1d5bd}", "\u{1d521}", "\u{0501}", "\u{2146}", "\u{1d451}", "\u{1d485}", "\u{1d555}", "\u{1d68d}", "\u{146f}", "\u{1d5f1}", "\u{217e}", "\u{1d589}", "\u{1d625}", "\u{1d4b9}"],
	"e": ["\u{1d556}", "\u{1d68e}", "\u{1d522}", "\u{04bd}", "\u{2147}", "\u{212e}", "\u{1d65a}", "\u{1d486}", "\u{1d5be}", "\u{1d41e}", "\u{1d626}", "\u{0435}", "\u{ab32}", "\u{1d452}", "\u{1d5f2}", "\u{1d58a}", "\u{212f}", "\u{ff45}", "\u{1d4ee}"],
	"f": ["\u{1d65b}", "\u{1d7cb}", "\u{1d5bf}", "\u{1d523}", "\u{1d41f}", "\u{1d487}", "\u{1d627}", "\u{1d557}", "\u{a799}", "\u{1d453}", "\u{0584}", "\u{1d5f3}", "\u{1d58b}", "\u{017f}", "\u{03dd}", "\u{ff46}", "\u{1d4ef}", "\u{1d4bb}", "\u{1e9d}", "\u{1d68f}", "\u{ab35}"],
	"g": ["\u{1d558}", "\u{1d690}", "\u{0261}", "\u{1d58c}", "\u{1d83}", "\u{1d488}", "\u{0581}", "\u{1d454}", "\u{210a}", "\u{1d628}", "\u{1d65c}", "\u{1d5f4}", "\u{1d4f0}", "\u{ff47}", "\u{018d}", "\u{1d524}", "\u{1d5c0}", "\u{1d420}"],
	"h": ["\u{0570}", "\u{1d421}", "\u{1d629}", "\u{1d559}", "\u{1d525}", "\u{1d5f5}", "\u{210e}", "\u{ff48}", "\u{04bb}", "\u{1d489}", "\u{1d58d}", "\u{1d65d}", "\u{13c2}", "\u{1d4f1}", "\u{1d691}", "\u{1d5c1}", "\u{1d4bd}"],
	"i": ["\u{2148}", "\u{1d422}", "\u{1d6a4}", "\u{0131}", "\u{1d7b2}", "\u{1d65e}", "\u{1d4f2}", "\u{1d48a}", "\u{ff49}", "\u{0456}", "\u{1d4be}", "\u{2170}", "\u{1d55a}", "\u{1d58e}", "\u{0269}", "\u{04cf}", "\u{1d6ca}", "\u{02db}", "\u{1d5c2}", "\u{037a}", "\u{118c3}", "\u{1d456}", "\u{a647}", "\u{1d778}", "\u{2373}", "\u{1d62a}", "\u{1d73e}", "\u{ab75}", "\u{1fbe}", "\u{13a5}", "\u{026a}", "\u{2139}", "\u{1d526}", "\u{1d692}", "\u{1d5f6}", "\u{1d704}", "\u{03b9}"],
	"j": ["\u{1d62b}", "\u{1d55b}", "\u{1d423}", "\u{1d48b}", "\u{1d58f}", "\u{03f3}", "\u{ff4a}", "\u{1d5c3}", "\u{1d4bf}", "\u{1d65f}", "\u{0458}", "\u{1d527}", "\u{1d5f7}", "\u{1d4f3}", "\u{2149}", "\u{1d457}", "\u{1d693}"],
	"k": ["\u{1d458}", "\u{1d55c}", "\u{1d4c0}", "\u{1d48c}", "\u{1d4f4}", "\u{1d590}", "\u{ff4b}", "\u{1d528}", "\u{1d5c4}", "\u{1d62c}", "\u{1d5f8}", "\u{1d660}", "\u{1d424}", "\u{1d694}"],
	"l": ["\u{0406}", "\u{ff4c}", "\u{23fd}", "\u{05c0}", "\u{217c}", "\u{1d6b0}", "\u{05df}", "\u{1d7f7}", "\u{1d43c}", "\u{1d4d8}", "\u{1d591}", "\u{1d661}", "\u{01c0}", "\u{fe8d}", "\u{1d5a8}", "\u{2110}", "\u{1d529}", "\u{10320}", "\u{1d7ed}", "\u{a4f2}", "\u{1d425}", "\u{1d6ea}", "\u{1d610}", "\u{07ca}", "\u{1d724}", "\u{1d4c1}", "\u{1d798}", "\u{0627}", "\u{2d4f}", "\u{2160}", "\u{1d7cf}", "\u{1d62d}", "\u{1d5f9}", "\u{ffe8}", "\u{0031}", "\u{1d4f5}", "\u{16f28}", "\u{1d459}", "\u{2111}", "\u{1d48d}", "\u{2223}", "\u{10309}", "\u{04c0}", "\u{0049}", "\u{1ee00}", "\u{0196}", "\u{16c1}", "\u{1d540}", "\u{1d5dc}", "\u{1d55d}", "\u{1ee80}", "\u{ff29}", "\u{2113}", "\u{2c92}", "\u{1d7e3}", "\u{1d678}", "\u{1d574}", "\u{1d695}", "\u{0399}", "\u{1d644}", "\u{1028a}", "\u{1d7d9}", "\u{fe8e}", "\u{ff11}", "\u{1d75e}", "\u{06f1}", "\u{007c}", "\u{1e8c7}", "\u{05d5}", "\u{1d470}", "\u{1fbf1}", "\u{0661}", "\u{1d408}", "\u{1d5c5}"],
	"m": ["\u{ff4d}"],
	"n": ["\u{1d45b}", "\u{1d5fb}", "\u{1d5c7}", "\u{1d48f}", "\u{ff4e}", "\u{1d593}", "\u{1d62f}", "\u{057c}", "\u{1d663}", "\u{0578}", "\u{1d52b}", "\u{1d4f7}", "\u{1d4c3}", "\u{1d697}", "\u{1d55f}", "\u{1d427}", "\u{03B7}"],
	...
	"y": ["\u{1d59e}", "\u{1d502}", "\u{0443}", "\u{1d466}", "\u{118dc}", "\u{0263}", "\u{1d49a}", "\u{1d6fe}", "\u{213d}", "\u{1d56a}", "\u{1d606}", "\u{1d5d2}", "\u{1d772}", "\u{04af}", "\u{1d63a}", "\u{1d8c}", "\u{1d432}", "\u{ab5a}", "\u{1d738}", "\u{1d4ce}", "\u{028f}", "\u{1d536}", "\u{1d6c4}", "\u{03b3}", "\u{ff59}", "\u{1eff}", "\u{1d6a2}", "\u{1d66e}", "\u{10e7}", "\u{1d7ac}"],
